...
class DQN_sb3_Agent:
    ...
    def __init__(self, color, game=None):
        ...
        self.model = None
        self.model_path = "./models/dqn_phase2.zip"  # Chemin du modèle SB3
        # self.input_shape = (5, 5, 8)
        self.input_shape = (5, 5, 5)  # Forme de l'état d'entrée pour le DQN
    ...
    def playsmart(self):
        ...
        print("Débogage : Appel de playsmart() pour l'IA SB3"), print()
